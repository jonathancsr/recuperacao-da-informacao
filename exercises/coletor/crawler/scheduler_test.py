...
class SchedulerTest(unittest.TestCase):
    ...
    def test_init(self):
        """
            Professor as urls inicialmente não possuiaam https
            O teste não testava nada
            Instanciava um array de strings iterava sobre ele e transformava em um array de urlparse e
            verificava se 3 era igual a 3 apenas
        """
        ...
        self.assertEqual(len(arr_str_urls_seeds), len(self.scheduler.dic_url_per_domain.keys()), "Nao foi adicionado as sementes solicitadas")
